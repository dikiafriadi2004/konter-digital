...
@section('content')
    <main class="flex-grow p-4 sm:p-6 lg:p-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-slate-500 md:ms-2 dark:text-slate-400">Create User</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <h2 class="text-2xl font-bold text-slate-800 dark:text-white">Create a New User</h2>
        </div>

        {{-- Form --}}
        <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md h-fit w-full">
            <h3 class="text-xl font-semibold text-slate-800 dark:text-white mb-6">New User Form</h3>
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                {{-- Password Confirmation (WAJIB untuk rule confirmed) --}}
                <div class="mb-4">

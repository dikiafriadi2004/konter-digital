...
@section('content')
    <main class="flex-grow p-4 sm:p-6 lg:p-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-slate-500 md:ms-2 dark:text-slate-400">Create Post</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <h2 class="text-2xl font-bold text-slate-800 dark:text-white">Create a New Post</h2>
        </div>
        ...
        <form action="{{ route('cms.posts.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="lg:col-span-2 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md">
                    <h3 class="text-xl font-semibold mb-6 text-slate-800 dark:text-white">Post Details</h3>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="post-title" name="title" value="{{ old('title') }}"
                            class="block w-full rounded-md border-slate-300 shadow-sm focus:ring-primary-500 p-3 dark:bg-slate-700 dark:border-slate-600 dark:text-white @error('title') border-red-500 @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="post-slug" name="slug" value="{{ old('slug') }}"
                            class="block w-full rounded-md border-slate-300 shadow-sm focus:ring-primary-500 p-3 dark:bg-slate-700 dark:border-slate-600 dark:text-white @error('slug') border-red-500 @enderror"
                            readonly>
                        @error('slug')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-4">
                        <label for="post-description"
                            ...
                            Meta Description <span class="text-xs text-slate-500">(Maks 160 karakter)</span>
                        </label>
                        <textarea id="post-description" name="meta_description" rows="3" maxlength="160" oninput="updateSeoDescCounter()"
                            class="block w-full rounded-md border-slate-300 shadow-sm focus:ring-primary-500 p-3 dark:bg-slate-700 dark:border-slate-600 dark:text-white @error('meta_description') border-red-500 @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="post-content" name="body" rows="15"
                            class="block w-full rounded-md border-slate-300 shadow-sm focus:ring-primary-500 p-3 dark:bg-slate-700 dark:border-slate-600 dark:text-white @error('body') border-red-500 @enderror"
                            placeholder="Tulis konten Anda di sini...">{{ old('body') }}</textarea>
                        @error('body')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="meta-keywords" name="meta_keywords" rows="2"
                            class="block w-full rounded-md border-slate-300 shadow-sm focus:ring-primary-500 p-3 dark:bg-slate-700 dark:border-slate-600 dark:text-white @error('meta_keywords') border-red-500 @enderror"
                            placeholder="Pisahkan dengan koma, cth: teknologi, web, css">{{ old('meta_keywords') }}</textarea>
                        @error('meta_keywords')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="lg:col-span-1 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md">
                    <h3 class="text-xl font-semibold mb-6 text-slate-800 dark:text-white">Post Settings</h3>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="post-status" name="status"
                            class="block w-full rounded-md border-slate-300 shadow-sm focus:ring-primary-500 p-3 dark:bg-slate-700 dark:border-slate-600 dark:text-white @error('status') border-red-500 @enderror">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="post-category" name="category_id"
                            class="block w-full rounded-md border-slate-300 shadow-sm focus:ring-primary-500 p-3 dark:bg-slate-700 dark:border-slate-600 dark:text-white @error('category_id') border-red-500 @enderror">
                    ...
                    <div class="mb-4">
                        ...
                        <div
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <p class="text-xs text-slate-500 dark:text-slate-400">PNG, JPG, GIF max 2MB</p>
                                <img id="thumbnail-preview"
                                    class="hidden mt-4 mx-auto max-h-48 rounded-md shadow-md object-cover">
                                @error('thumbnail')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
            ...
            <div class="flex justify-end space-x-3 mt-6">
                ...
                <button type="submit"
                    class="px-5 py-2.5 bg-primary-600 text-white rounded-lg font-semibold hover:bg-primary-700">
                    Simpan Postingan
                </button>
            </div>
        </form>

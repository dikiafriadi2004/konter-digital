                ...
                <div class="lg:col-span-2 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md">
                    ...
                    <div class="mb-4">
                        <label for="post-description"
                            ...
                            Meta Description Singkat <span class="text-xs text-slate-500">(Maks 160 karakter)</span>
                        </label>
                        <textarea id="post-description" name="meta_description" rows="3" maxlength="160" oninput="updateSeoDescCounter()"
                            ...
                            placeholder="Masukkan deskripsi singkat (maksimal 160 karakter)...">{{ old('meta_description') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="post-content" name="body" rows="15"
                            ...
                            placeholder="Tulis konten postingan Anda di sini..." required>{{ old('body') }}</textarea>
                        @error('body')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <img id="thumbnail-preview" src="#" alt="Pratinjau Thumbnail"
...
@push('js')
    <script>
        ...
        function updateSeoDescCounter() {
            ...
            // Jika terlalu panjang, beri warna merah
            if (length > 160) {
